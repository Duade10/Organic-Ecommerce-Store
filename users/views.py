...
def user_profile(request, user_id):
    ...
    order_count = Order.objects.filter(user=current_user, is_ordered=True).count()
    return render(request, "users/dashboard.html", {"current_user": current_user, "order_count": order_count})
